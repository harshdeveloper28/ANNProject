...
# streamlit app \
st.title("📊 Customer Churn Prediction Result")
...
geo_encode = onehot_encoder.transform([[Geography]]).toarray()
geo_encode_df = pd.DataFrame(geo_encode,columns=onehot_encoder.get_feature_names_out(['Geography']))

# combining one hot encoded data with input data 
...
# Display churn status with color feedback
